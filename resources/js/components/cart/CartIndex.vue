<template>
    <div class="container flex">
        <div class="w-full mx-auto p-6 mb-8 overflow-hidden rounded-lg shadow-lg">
            ...
            <div v-else>
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white">
                        <tr class="text-gray-700" v-for="product in shoppingCart" :key="product.id">
                            ...
                            <td class="px-4 py-3 border">
                                <div class="flex items-center text-sm">
                                    <input v-model="product.amount" type="number" class="font-semibold text-black"/>
                                </div>
                            </td>
                            <td class="px-4 py-3 border">
                                <div class="flex items-center text-sm">
                            ...
                            <td class="px-4 py-3 border">
                                <div class="flex items-center text-sm">
                                    <p class="font-semibold text-black">
                                        {{ currencyCOP(product.price * product.amount) }}
                                    </p>
                                </div>
                            </td>
                            <td class="px-4 py-3 border">
